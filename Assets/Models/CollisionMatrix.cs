...
namespace Models
{
    public class CollisionMatrix
    {
        ...
        public CollisionMatrix(IList<object> reader)
        {
            IList<object> names = (IList<object>)reader[0];
            ...
            {
                int result = 0;
                IList<object> layerData = (IList<object>)reader[layers.Count - i];
                ...
                {
                    if ((bool)((IList<object>)reader[j])[i])
                    {
                        result |= layers[k];
                    }
                }
